...
se invertio completamente la palabra para evitar comparar individualmente letra por letra, una vez invertido,
...
public boolean esPalindromo(String texto) {
    ...
    return texto.equals(invert);

    //String invertido = new Ejercicio1().invertString(texto);
    //return texto.equalsIgnoreCase(invertido);                                MAS SENCILLO USANDO EL METODO YA CREADO
}
